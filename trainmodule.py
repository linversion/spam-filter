...
class TrainModule:
	...
	def __init__(self):
		...
		self.PRE_DEFINED_WORD_FREQ = 0.0001    #预定义的词频为0.0001

		self.WORD_FREQ_FILE = '/tmp/freq_file.txt'    #将词频数据写入freq_file文件
	...
	def build_freq_dict(self):
		...
		self.build_word_list('/tmp/data')    #指定邮件目录/tmp/data来构建词频字典
